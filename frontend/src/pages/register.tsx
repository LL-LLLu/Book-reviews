...
export default function Register() {
  ...
  useEffect(() => {
    ...
    if (error) {
      switch (error) {
        case 'UserExists':
          toast.error('This Google account is already registered. Please go to the login page to sign in.');
          // Optionally redirect to login page after showing the error
          setTimeout(() => {
            router.push('/login');
          }, 3000);
          break;
      ...
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-black dark:text-white mb-3">Create Account</h1>
